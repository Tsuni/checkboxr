                      ...
                      <a
                        ...
                        className={classNames(
                          item.current
                            ...
                            : 'text-stone-700 hover:bg-stone-300 hover:text-stone-700',
            ...
            <nav className="mt-5 flex-1 space-y-1 bg-stone-200 px-2">
              {navigation.map((item) => (
                <a
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'bg-stone-300 text-stone-700' : 'text-stone-500 hover:bg-gray-50 hover:text-gray-900',
                    'group flex items-center px-2 py-2 text-sm font-medium rounded-md'
                  )}
                >
                  <item.icon
                    className={classNames(
                      item.current ? 'text-stone-700' : 'text-stone-500 group-hover:text-gray-500',
